...
export const FIND_CART_ITEMS = `SELECT CI.id, CI.menu_item_id, cart_id, C.restaurant_id, MI.item_name AS menu_item_name, MI.description, MI.price, quantity, R.name AS restaurant_name , C.discount, MI.item_img AS image
  FROM cart_items CI
