...
export default function AdminDashboard() {
  ...
  async function updateOrder(orderId: number, changes: { orderStatus?: string; riderId?: number | null }) {
    try {
